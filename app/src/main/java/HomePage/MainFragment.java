...
import com.vnpt.mydailyfitness.HustCare.Exercise.DayActivity;
import com.vnpt.mydailyfitness.HustCare.Exercise.Workout;
import com.vnpt.mydailyfitness.HustCare.Exercise.WorkoutData;
import com.vnpt.mydailyfitness.HustCare.SlidingAdapter;
import com.vnpt.mydailyfitness.HustCare.SlidingModel;
...
public class MainFragment extends Fragment {
    ...
    public DbOperation databaseOperations;
    ...
    private int[] myImageList = new int[]{R.drawable.banner_1, R.mipmap.banner_calculator, R.mipmap.img_reminder};
...
//                MainFragment.this.adapter.notifyDataSetChanged();
    ...
    public void a(int i, MaterialDialog materialDialog, DialogAction dialogAction) {
        ...
        try {
            ...
            this.databaseOperations.updateExcProgress(str2, 0.0f);
            this.databaseOperations.updateExcCounter(str2, 0);
            this.workoutDataList = this.databaseOperations.getAllDayData();
...
//            this.recyclerView.setAdapter(this.adapter);
 ...
 RelativeLayout i_plus;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        progressBar1 = (ProgressBar) inflate.findViewById(R.id.progress1);
        ...
        this.databaseOperations = new DbOperation(getActivity());
...
//        this.height = displayMetrics.heightPixels;
        if (!z2 && this.databaseOperations.checkDbEmpty() == 0) {
            this.databaseOperations.insertAllDayData();
            SharedPreferences.Editor edit = this.launchDataPreferences.edit();
        ...
        rel_three.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mainAcdsctivity.openWorkoutFragment();
            }
        });
        ...
        this.workoutDataList = databaseOperations.getAllDayData();
